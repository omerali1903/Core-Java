...
public enum UsStatesEnum {
    ...
    UsStatesEnum(String stateName, String abbrevation, String capital) {
    ...
    //State kisalmasini verince state'in ismini veren method
    public static String getStateNameByUsingAbbrevation(String abbrevation) {
        return Arrays.stream(values())
                .filter(usState -> usState.getAbbrevation().equals(abbrevation))
